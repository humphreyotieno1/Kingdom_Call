    ...
    <footer className="bg-black text-white py-8 px-4">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm mt-2 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit Nunc maximus</p>
          <div className="flex mt-4 space-x-4">
            ...
            <a href="#" className="text-white"><FontAwesomeIcon icon={faLinkedin} className="text-2xl" /></a>
            <a href="#" className="text-white"><FontAwesomeIcon icon={faYoutube} className="text-2xl" /></a>
          </div>
        </div>
        <div className="flex flex-col items-center">
          <h3 className="text-xl font-bold">Contact Us</h3>
          <p className="mt-2"><FontAwesomeIcon icon={faPhone} /> +91 98765 43210</p>
          <p className="mt-1"><FontAwesomeIcon icon={faEnvelope} /> info@example.com</p>
          <p className="mt-1"><FontAwesomeIcon icon={faMapMarkerAlt} /> Lorem ipsum dolor sit amet</p>
        </div>
        <div className="flex flex-col items-center">
