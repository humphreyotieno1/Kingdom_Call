      ...
      <div className="flex flex-col md:flex-row justify-between items-center py-2 px-4 text-sm w-full">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col">
            <Link to="/" className="hover:text-gray-700 text-2xl font-extrabold">
              Kingdom Call
            </Link>
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link to="/about-us" className="py-2 px-3 hover:text-gray-700">
            About Us
          </Link>
          <Link to="/services" className="py-2 px-3 hover:text-gray-700">
            Services
          </Link>
          <Link to="/departments" className="py-2 px-3 hover:text-gray-700">
            Departments
          </Link>
          ...
          <div className="relative">
            ...
            <div
              className={`absolute left-0 mt-2 z-10 ${
                activeDropdown === 'mediaDropdown' ? '' : 'hidden'
              } font-normal bg-[#E48515] divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}
            >
          ...
          <div className="relative">
            ...
            <div
              className={`absolute left-0 mt-2 z-10 ${
                activeDropdown === 'resourcesDropdown' ? '' : 'hidden'
              } font-normal bg-[#E48515] divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}
            >
              <div className="py-2 text-sm text-gray-700 dark:text-gray-400">
                <Link
          ...
          <Link to="/contact" className="py-2 px-3 hover:text-gray-700">
            Contact
          </Link>
        ...
        <div className="md:hidden flex flex-col w-full">
          ...
          {/* Mobile Links */}
          <div className={`flex flex-col px-4 mt-4 ${isMenuOpen ? '' : 'hidden'}`}>
            <Link
              to="/about-us"
            ...
            <button
              ...
              className="py-2 flex justify-between items-center hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
            >
              Media
              <svg
            ...
            <div
              className={`pl-4 ${activeDropdown === 'mobileMediaDropdown' ? '' : 'hidden'}`}
            >
              <Link
                to="/videos"
            ...
            <div
              className={`pl-4 ${activeDropdown === 'mobileResourcesDropdown' ? '' : 'hidden'}`}
            >
              <Link
                to="/testimonies"
                className="block py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
