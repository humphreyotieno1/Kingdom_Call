      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full px-4 md:px-16 lg:px-32 mx-4 md:mx-20 lg:mx-40">
        ...
        <div className="border border-[#E48515] p-6 rounded-lg">
          ...
          <p className="text-gray-700 mb-4 text-center">
            Our values are the guiding principles that help us to fulfill our mission and vision as a ministry.
          </p>
          <div className="flex justify-center">
            <button
              onClick={() => navigate("/about-us/who-we-are")}
        ...
        <div className="border border-[#E48515] p-6 rounded-lg">
          ...
          <p className="text-gray-700 mb-4 text-center">
            Our purpose is to see the Kingdom of God established. We are a people of purpose and destiny.
          </p>
          <div className="flex justify-center">
            {/* <button 
        ...
        <div className="border border-[#E48515] p-6 rounded-lg">
          ...
          <p className="text-gray-700 mb-4 text-center">
            Learn about our journey so far and how we have grown to become who we are today.
          </p>
          <div className="flex justify-center">
            <button
